...
{
/*Begin lenovo-sw wengjun1 modify for prada lg4591 display issue.2013-3-7*/  
...
#endif
/*End lenovo-sw wengjun1 modify for prada lg4591 display issue.2013-3-7*/
...
void dsi_esd_reset(void)
{
    ...
    if(lcm_params->dsi.mode == CMD_MODE) {
        ...
        DSI_clk_HS_mode(0);
#if defined(LENOVO_PROJECT_SEINE)//lenovo jixu add
        DSI_clk_ULP_mode(0);            
        DSI_lane0_ULP_mode(0); 
#endif
